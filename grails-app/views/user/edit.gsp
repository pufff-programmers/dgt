...
<%@ page import="com.pufff.domain.user.User" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="alertas"><g:message code="user.alertas.label" default="Alertas" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'alertas', 'errors')}">
                                    
<ul>
<g:each in="${userInstance?.alertas?}" var="a">
    <li><g:link controller="alerta" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="alerta" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'alerta.label', default: 'Alerta')])}</g:link>
